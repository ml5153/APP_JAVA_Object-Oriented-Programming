package com.sparta.running.day01.step4;
...
public class Main {
    public static void main(String[] args) {
        ...
        // 상황 3: 야간에는 멍멍이 바리스타 근무
        System.out.println("\n[2] 야간반: 모찌 바리스타 근무");
        CoffeeMaker dog = new DogBarista();
        Cashier nightCashier = new Cashier(dog);
        customer.order("따뜻한 카푸치노", nightCashier);
